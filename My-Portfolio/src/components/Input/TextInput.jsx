const TextInput = ({ isDarkMode, value, handleChange, textarea, label }) => {
  const InputComponent = textarea ? "textarea" : "input";
  return (
    <div className="relative">
      <InputComponent
        type="text"
        className={`w-full px-4 pt-6 pb-4 border rounded-xl transition-all duration-300 outline-none resize-none
           ${
             isDarkMode
